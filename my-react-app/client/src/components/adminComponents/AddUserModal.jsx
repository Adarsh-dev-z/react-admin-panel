                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            {...register("email", {
                                ...
                                validate: (value) => value.trim() !== "" || /\S+@\S+\.\S+/.test(value) || "Email must be a valid format",
                            })}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            {...register("phone", {
                                ...
                                validate: (value) => value.trim() !== "" && (/^\d{10}$/.test(value) || "Phone number must be 10 digits"),
                            })}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                            maxLength={10}
                        />
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            {...register("password", {
                                ...
                                validate: (value) => value.trim() !== "" && (value.length >= 8 || "Password must be at least 8 characters"),
                            })}
                            className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        />
