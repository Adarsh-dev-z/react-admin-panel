    ...
    <div className="container mx-auto mt-24 px-4 sm:px-6 lg:px-8"> 
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <button 
          ...
          className={`w-full sm:w-auto px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200 ease-in-out ${selectedUsersIds.length === 0 ? "opacity-50 cursor-not-allowed" : ""}`}        >
          Delete selected
        </button>
      </div>
